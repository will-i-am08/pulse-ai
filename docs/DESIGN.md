...
**Marketing language (proposal):** see [`DESIGN_LANGUAGE.md`](DESIGN_LANGUAGE.md) — *Charcoal Field* (abstract ink plates for posters/posts; no neon) — and the specimen at [`prototype/design-language/index.html`](../prototype/design-language/index.html). Product chrome in this file stays the source of truth until that proposal is locked.
