...
export const metadata = { title: 'Users · Operator | Kip' };
  ...
  return (
    <section className="stage">
      <div className="page">
        ...
        <p className="lead">
          Every account and their brand. Click a user to open their profile. Deactivate is reversible; delete is permanent.
        </p>
        ...
        {unownedBrands.length > 0 && (
          <>
            <h2 className="page-h1" style={{ marginTop: 40 }}>
              Unowned brands
            </h2>
